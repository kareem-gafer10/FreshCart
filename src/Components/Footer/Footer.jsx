...
const Footer = () => {
  return (
    <>
     ...
     <p className='text-muted'>We will send you a link, Open it in your phone to download App</p>
      ...
      <div className="col-md-3">
        <button className='btn btn-success w-100 mt-3 mt-md-0'>Share App Link</button>
      </div>
    ...
    <div className="col-lg-6">
        <div className=" d-flex align-items-center">
        <h6 className='text-muted me-4 footer-title'>Get deliveries with FreshCart</h6>
        {stores.map((store) => {
              const { id, image, alt } = store;
              return <img src={image} className="storeImg cursor-pointer" alt={alt} key={id} />;
            })}
        </div>
      ...
      <div className="copy-right">
        <p className="text-center">
          Copy Right 2023 © By Kareem Gafer All Rights Reserved
        </p>
      </div>
